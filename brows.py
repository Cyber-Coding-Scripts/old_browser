...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action.setStatusTip("Find out more about Cyber-Browse")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')), "Cyber-Browse Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Cyber-Browse Homepage")
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Cyber-Browse" % title)
